        ...
        try:
            ...
            if valid_author:
                ...
                if answer_marked_correct:
                    print(answer_marked_correct['answers.markedcorrect'])
